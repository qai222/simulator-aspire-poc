...
# RACK B: holding HRVs for reactions, at 2-3-2 initially, one for RSO2Cl stock solution,
# another for pyridine source
...
# )
RACK_B, RACK_B_VIALS = JuniorRack.create_rack_with_empty_vials(
    n_vials=CONCURRENCY*2 + 1, rack_capacity=8, vial_type="HRV", rack_id="RACK B"
)
RACK_B: JuniorRack
...
DCM_VIALS_1 = RACK_A_VIALS[:1]
MRV_VIALS_1 = RACK_C_VIALS[:1]
DCM_VIALS_2 = RACK_A_VIALS[1:]
MRV_VIALS_2 = RACK_C_VIALS[1:]

PYRIDINE_VIAL = RACK_B_VIALS[0]
# PYRIDINE_VIAL.chemical_content = {"pyridine": 1000}
PYRIDINE_VIAL.chemical_content = {"pyridine": 2000}
# RSO2Cl_STOCK_SOLUTION_VIALS = RACK_B_VIALS[1:]
RSO2Cl_STOCK_SOLUTION_VIALS_1 = RACK_B_VIALS[1:2]
RSO2Cl_STOCK_SOLUTION_VIALS_2 = RACK_B_VIALS[2:3]
...
ins_list9 = pdp_dispense(PYRIDINE_VIAL,
